(function(angular) {
	...
	angular.module("WidgetApp",
		["ui.router","WidgetApp.Controllers","WidgetApp.Filters"])
		.run(function($templateCache) {
			...
			<form novalidate name="widgetForm">
				...
				<div>
					...
					<div>
						<label>Description:
							<input ng-model="widget.description" name="widgetDescription" required>
						</label>
					...
					<div>
						<label>Size:
							<input ng-model="widget.size" name="widgetSize" required>
						</label>
						<span ng-show="widgetForm.widgetSize.$invalid && widgetForm.widgetSize.$touched">
							Please enter a size.
						</span>
					</div>
					<div>
				...
				<button type="button" ng-click="deleteWidget()" ng-if="widget.id">Delete</button>
